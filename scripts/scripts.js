...
class Twitter {
   constructor({ 
      ...
      this.elements.listElem.addEventListener('click', this.hadlerTweet);
                        ...
                        <div class="tweet-post">
                           ...
                           ${
                              ...
                              `<figure class="tweet-post__image">
                                 <img src="${img}" alt="илюстрация поста ${nickname}">
                              </figure>` :
                              ''
                           }
   ...
   addTweet( { text, img, submit }) {
      ...
      imgElem.addEventListener('click', () => {
         imgUrl = prompt('Ввведите адрес картинки');
      });
   }
